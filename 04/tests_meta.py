...
class TestCustomClass(unittest.TestCase):
    ...
    def test_right_class_var(self):

        self.assertTrue(hasattr(CustomClass, 'custom_x'))

    def test_false_class_var(self):

        self.assertFalse(hasattr(CustomClass, 'x'))

    def test_right_inst_class_var(self):

        inst = CustomClass()
        self.assertTrue(hasattr(inst, 'custom_x'))

    def test_false_inst_class_var(self):

        inst = CustomClass()
        self.assertFalse(hasattr(inst, 'x'))

    def test_right_inst_class_init_val(self):

        inst = CustomClass()
        self.assertTrue(hasattr(inst, 'custom_val'))

    def test_false_inst_class_init_val(self):
    ...
    def test_right_class_method(self):

        inst = CustomClass()
        self.assertTrue(hasattr(inst, 'custom_line'))

    def test_false_class_method(self):
    ...
    def test_right_class_magic_method(self):

        inst = CustomClass()
        self.assertTrue(hasattr(inst, '__str__'))

    def test_false_class_magic_method(self):

        inst = CustomClass()
        self.assertFalse(hasattr(inst, 'custom___str__'))

    def test_right_class_dynamic_var(self):

        inst = CustomClass()
        inst.dynamic = "added later"
        self.assertTrue(hasattr(inst, 'custom_dynamic'))

    def test_false_class_dynamic_var(self):

        inst = CustomClass()
        inst.dynamic = "added later"
        self.assertFalse(hasattr(inst, 'dynamic'))

    def test_right_class_fake_magic_method(self):

        inst = CustomClass()
        self.assertTrue(hasattr(inst, 'custom_static_line__'))

    def test_false_class_fake_magic_method(self):
